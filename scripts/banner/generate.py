...
ROWS = [
    ("Subject", "Leonardo Gonzalez"),
    ("Role", "Backend & Systems Engineer"),
    ("Origin", "Chiapas, Mexico"),
    ("Education", "Ing. Sistemas Computacionales (ITTG)"),
    ("Status", "Building + Learning + Shipping"),
    ("ToolChain", "PyCharm · VS Code · Git"),
    ("Core.Lang", "Python · PHP · JavaScript · Kotlin"),
    ("Core.Backend", "Django · Laravel · REST APIs"),
    ("Core.Database", "MySQL · PostgreSQL · SQL"),
    ("Core.Mobile", "Android Studio · Kotlin"),
    ("Grid.Mail", "leo.sanchez.dev@gmail.com"),
    ("Grid.LinkedIn", "/in/leonardogs4015053a5"),
    ("Grid.GitHub", "leon200331"),
    ("Grid.Instagram", "@leonardo_gs27"),
]
...
def render_svg(
    ...
    parts: list[str] = [
        ...
        '<title id="title">Leonardo\'s live system profile</title>',
        '<desc id="desc">Animated terminal profile with a dithered portrait and '
        'tech stack silhouettes.</desc>',
        "<defs>",
    ...
    parts.extend(
        [
            ...
            'font-weight="700">@leon200331</text>',
        ]
    )
